...
public final class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        YwUtils.getApp().startActivity(new Intent(android.provider.Settings.ACTION_WIRELESS_SETTINGS)
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        ConnectivityManager manager =
                (ConnectivityManager) YwUtils.getApp().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) YwUtils.getApp().getSystemService(Context.WIFI_SERVICE);
