...
public final class PhoneUtils {
    ...
    public static boolean isPhone() {
        TelephonyManager tm =
                (TelephonyManager) YwUtils.getApp().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static void dial(final String phoneNumber) {
        YwUtils.getApp().startActivity(IntentUtils.getDialIntent(phoneNumber, true));
    }
    ...
    public static void call(final String phoneNumber) {
        YwUtils.getApp().startActivity(IntentUtils.getCallIntent(phoneNumber, true));
    }
    ...
    public static void sendSms(final String phoneNumber, final String content) {
        YwUtils.getApp().startActivity(IntentUtils.getSendSmsIntent(phoneNumber, content, true));
    }
    ...
    public static void sendSmsSilent(final String phoneNumber, final String content) {
        ...
        PendingIntent sentIntent = PendingIntent.getBroadcast(YwUtils.getApp(), 0, new Intent(), 0);
