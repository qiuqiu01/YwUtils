...
public final class ActivityUtils {
    ...
    public static boolean isActivityExists(@NonNull final String packageName,
        ...
        return !(YwUtils.getApp().getPackageManager().resolveActivity(intent, 0) == null ||
                intent.resolveActivity(YwUtils.getApp().getPackageManager()) == null ||
                YwUtils.getApp().getPackageManager().queryIntentActivities(intent, 0).size() == 0);
    }
    ...
    public static String getLauncherActivity() {
        return getLauncherActivity(YwUtils.getApp().getPackageName());
    }
    ...
    public static Activity getTopActivity() {
        if (YwUtils.sTopActivityWeakRef != null) {
            Activity activity = YwUtils.sTopActivityWeakRef.get();
            if (activity != null) {
                return activity;
            }
        }
        List<Activity> activities = YwUtils.sActivityList;
    ...
    private static Context getActivityOrApp() {
        ...
        return topActivity == null ? YwUtils.getApp() : topActivity;
    }
