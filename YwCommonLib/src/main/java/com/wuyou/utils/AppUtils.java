...
public final class AppUtils {
     ...
     * @param context   context
     * @param packageName 包名
     * @return The version name of this package（App版本名）
     */
     ...
     * @param context   context
     * @param packageName apk包名
     * @return {@code true}: 系统App <br>{@code false}: 用户App
     */
     ...
     * **************************************无需init***********************************************
     * @param context   context
     * @param className 服务类全路径---格式："com.xxx.xx..XxxService"
     * @return {@code true}: 服务在后台运行 <br>{@code false}: 服务不在后台运行
     */
     ...
     * @param context   context
     * @param className 服务类全路径---格式："com.xxx.xx..XxxService"
     * @return {@code true}: 成功关闭服务 <br>{@code false}: 关闭失败
     */
    ...
    public static boolean isInstallApp(final String action, final String category) {
        ...
        PackageManager pm = YwUtils.getApp().getPackageManager();
    ...
    *  <br>参看 https://developer.android.com/reference/android/support/v4/content/FileProvider.html
    ...
    public static void installApp(final File file, final String authority) {
        ...
        YwUtils.getApp().startActivity(IntentUtils.getInstallAppIntent(file, authority, true));
    }
    ...
    public static void uninstallApp(final String packageName) {
        ...
        YwUtils.getApp().startActivity(IntentUtils.getUninstallAppIntent(packageName, true));
    }
    ...
    public static void launchApp(final String packageName) {
        if (isSpace(packageName)) return;
        YwUtils.getApp().startActivity(IntentUtils.getLaunchAppIntent(packageName, true));
    }
    ...
    public static void exitApp() {
        List<Activity> activityList = YwUtils.sActivityList;
    ...
    public static String getAppPackageName() {
        return YwUtils.getApp().getPackageName();
    }
    ...
    public static void getAppDetailsSettings() {
        getAppDetailsSettings(YwUtils.getApp().getPackageName());
    }
    ...
    public static void getAppDetailsSettings(final String packageName) {
        if (isSpace(packageName)) return;
        YwUtils.getApp().startActivity(IntentUtils.getAppDetailsSettingsIntent(packageName, true));
    }
    ...
    public static String getAppName() {
        return getAppName(YwUtils.getApp().getPackageName());
    }
    ...
    public static Drawable getAppIcon() {
        return getAppIcon(YwUtils.getApp().getPackageName());
    }
    ...
    public static String getAppPath() {
        return getAppPath(YwUtils.getApp().getPackageName());
    }
    ...
    public static String getAppVersionName() {
        return getAppVersionName(YwUtils.getApp().getPackageName());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(YwUtils.getApp().getPackageName());
    }
    ...
    public static boolean isSystemApp() {
        return isSystemApp(YwUtils.getApp().getPackageName());
    }
    ...
    public static boolean isAppDebug() {
        return isAppDebug(YwUtils.getApp().getPackageName());
    }
    ...
    public static Signature[] getAppSignature() {
        return getAppSignature(YwUtils.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureSHA1() {
        return getAppSignatureSHA1(YwUtils.getApp().getPackageName());
    }
    ...
    public static boolean isAppForeground() {
        ActivityManager manager =
                (ActivityManager) YwUtils.getApp().getSystemService(Context.ACTIVITY_SERVICE);
        List<ActivityManager.RunningAppProcessInfo> info = manager.getRunningAppProcesses();
        if (info == null || info.size() == 0) return false;
        for (ActivityManager.RunningAppProcessInfo aInfo : info) {
            if (aInfo.importance == ActivityManager.RunningAppProcessInfo.IMPORTANCE_FOREGROUND) {
                return aInfo.processName.equals(YwUtils.getApp().getPackageName());
            }
        }
        return false;
    }
    ...
    public static AppInfo getAppInfo() {
        return getAppInfo(YwUtils.getApp().getPackageName());
    }
