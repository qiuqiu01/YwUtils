...
public class CrashUtils {
    ...
    static {
        try {
            PackageInfo pi = YwUtils.getApp()
                    .getPackageManager()
                    .getPackageInfo(YwUtils.getApp().getPackageName(), 0);
            if (pi != null) {
    ...
    public static void init(final String crashDir) {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                && YwUtils.getApp().getExternalCacheDir() != null)
            defaultDir = YwUtils.getApp().getExternalCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        else {
            defaultDir = YwUtils.getApp().getCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        }
